...
#endif
{
    ...
    private static void AddDependenciesToProjectJson(string projectJsonPath)
    {
        ...
        jsonString = AddDependencyToProjectJson(jsonString, "Microsoft.NETCore.UniversalWindowsPlatform", "6.2.8");
        jsonString = AddDependencyToProjectJson(jsonString, "Newtonsoft.Json", "12.0.2");
